...
#define BUTTON_TYPE 0           /* Тип кнопки: 0 - сенсорная (touch button); 1 - обычная кнопка на замыкание при нажатии (или если кнопки нет вообще)  */
#define USE_BUTTON 1            /* 1 - использовать кнопку управления; 0 - не использовать                                                             */
#define USE_OTA 0               /* 1 - использовать обновление "по воздуху", 0 - не использовать                                                       */
...
#define LED_PIN D4              // D2 пин ленты
#define PIN_BTN D2              // физическая кнопка подключена сюда (D1--- КНОПКА --- GND);
